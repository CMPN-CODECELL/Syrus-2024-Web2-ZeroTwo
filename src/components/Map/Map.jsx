...
const MAPBOX_TOKEN = "pk.eyJ1IjoibXJ1bmFsMTIzNDU2Nzg5IiwiYSI6ImNsbWhzbWF2cTBzajAzcXIybTVoa3g1anQifQ.66Fu05Ii8-NVd-w-C-FSgA";

const Map = ({ places, setBounds, setClickedMarker, containerRef, mode }) => {
    const classes = useStyles();
    const desktopScreen = useMediaQuery("(min-width:200px)");
